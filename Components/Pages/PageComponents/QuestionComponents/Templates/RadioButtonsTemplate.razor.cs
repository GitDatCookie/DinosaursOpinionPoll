...
{
    public partial class RadioButtonsTemplate
    {
        ...
        private int RadioButtonMin { get; set; } = 2;
        ...
        protected override void OnInitialized()
        {
            ...
            {
                InitialiseOptions("Radiobutton", 3);
            }
        ...
        private async void SaveQuestion()
        {
            ...
            {
                QuestionType = Enums.EQuestionComponentType.RadioButton,
                Title = Title,
